      ...
      <div className="max-w-6xl mx-auto">
        <header className="flex justify-between items-center py-6">
          <div className="flex items-center space-x-2">
            <img 
              ...
              className="h-10 w-10"
            />
            <h1 className="text-2xl font-bold">OrthoBoost</h1>
          </div>
          <div className="flex items-center space-x-4">
            <a href="/login" className="px-4 py-2 bg-primary text-white rounded-lg hover:bg-primary/90 transition-colors">
              Login
            </a>
          </div>
        </header>
        ...
        <main className="py-12">
          <section className="text-center mb-16">
            <h2 className="text-4xl md:text-6xl font-bold mb-6">Rendre l'Orthophonie Engageante</h2>
...
const LandingPage = () => {
  ...
  return !isAuthenticated ? <LandingPageContent /> : null;
};
